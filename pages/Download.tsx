        ...
        <div className="p-2 rounded-md bg-gray-600 bg-opacity-70 shadow-md text-white drop-shadow-lg mt-5 md:p-5">
            ...
            <div>
                ...
                <div className="flex-col items-center">
                    <p className="text-3xl mb-2 text-transparent bg-clip-text bg-gradient-to-r to-orange-600 from-yellow-200">
                        Downloads
                    </p>
                    <div className="flex">
                           ...
                           <>
                                <button onClick={toggleWindowsLinks}>
                                    {/* Windows Support */}
                                    <div className="bg-slate-800 rounded-md p-2 flex items-center drop-shadow-md gap-1">
                    ...
                    <div className="gap-1 items-center pt-2 pb-2">
                        ...
                        {windowsLinksMenu ? <>
                            {clientWindowsLink.map((key) => (
                                <button>
                                <div className="mt-1 me-4 bg-slate-800 rounded-md p-2 flex items-center drop-shadow-md gap-1 hover:text-yellow-300 hover:outline-dashed hover:outline-2">
                                    {/* Client Icon */}
